...
public static class EcoGnomeChatCommand
{
    ...
    [ChatSubCommand("EcoGnome", "Same as SyncShop, but only applies on sells categories.", ChatAuthorizationLevel.User)]
    ...
    [ChatSubCommand("EcoGnome", "Add offers for all items in Eco Gnome, grouped in categories by margin name. You can specify a context name if you don't want to retrieve the default context.", ChatAuthorizationLevel.User)]
    ...
    [ChatSubCommand("EcoGnome", "Same as CreateShop, but creates only the sell offers.", ChatAuthorizationLevel.User)]
    ...
    [ChatSubCommand("EcoGnome", "Same as CreateShop, but creates only the buy offers.", ChatAuthorizationLevel.User)]
